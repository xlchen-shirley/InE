...
class AttentionRefinementModule(nn.Module):
    def __init__(self, in_chan, out_chan, *args, **kwargs):
        ...
        self.conv_atten = nn.Conv2d(out_chan, out_chan, kernel_size=1, bias=False)
        self.bn_atten = nn.BatchNorm2d(out_chan) #nn.LayerNorm([out_chan, 1, 1])
        self.sigmoid_atten = nn.Sigmoid()
        self.init_weight()
...
class BiSeNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # get_feature(feat_out, 'ir_81_feat_out',True)
        # get_feature(feat_out16, 'ir_81_feat_out16',True)
        # exit(0)
        ...
        # get_feature(feat_out, 'ir_127_feat_out',True)
        # get_feature(feat_out16, 'ir_127_feat_out16',True)
        # exit(0)
